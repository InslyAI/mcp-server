...
export function registerGetBrokerEventsTools(server: McpServer) {
  server.tool(
    ...
    "Get list of sales policy events for a specific broker within a date range",
    {
      ...
      broker: z.string().min(1).describe("Broker short name or identifier"),
      from: z.string().datetime().describe("Start date in ISO format (e.g., '2023-11-16T00:00:00+02:00')"),
      to: z.string().datetime().describe("End date in ISO format (e.g., '2023-11-17T23:59:59+02:00')"),
