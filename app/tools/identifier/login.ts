...
export function registerIdentifierLoginTool(server: McpServer) {
  server.tool(
    ...
    "Login to Insly Identifier service with username and password to get JWT bearer token. This token is required for all Ledger API operations.",
    {
      username: z
        .string()
        .describe("Insly username/email (e.g., rasim.mehtijev@insly.com)"),
                ...
                text: JSON.stringify(
                  {
                    ...
                    tenant: tenantTag,
                    message:
                      "Login successful! Use the access_token as bearerToken for Ledger API calls.",
                    usage: {
                ...
                text: JSON.stringify(
                  {
                    ...
                    nextSteps:
                      "Use identifier_challenge tool to complete authentication",
                  },
                  null,
                  2,
                ),
              ...
              text: JSON.stringify(
                {
                  ...
                  troubleshooting: {
                    credentials:
                      "Verify username, password, and tenantTag are correct",
