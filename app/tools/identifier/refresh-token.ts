...
export function registerIdentifierRefreshTokenTool(server: McpServer) {
  server.tool(
    ...
    {
      refreshToken: z.string().describe("Refresh token obtained from previous login"),
      username: z.string().describe("Username that was used for the original login"),
            ...
            content: [
              {
                ...
                text: JSON.stringify({
                  ...
                  tenant: tenantTag,
                  message: "Token refresh successful! Use the new access_token as bearerToken for Ledger API calls.",
                  usage: {
            ...
            content: [
              {
                ...
                text: JSON.stringify({
                  ...
                  nextSteps: "May need to re-authenticate with identifier_login"
                }, null, 2)
              }
            ]
          };
          ...
          content: [
            {
              ...
              text: JSON.stringify({
                ...
                response: result,
                troubleshooting: {
                  refreshToken: "Verify refresh token is valid and not expired",
                  username: "Ensure username matches the original login",
                  tenant: "Check tenant identifier is correct",
                  reAuthenticate: "Consider using identifier_login to get new tokens"
                }
              }, null, 2)
            }
          ]
          ...
          content: [
            {
              ...
              text: JSON.stringify({
                ...
                troubleshooting: {
                  ...
                  tenant: "Ensure tenant identifier is correct ('accelerate')",
                  network: "Check network access to https://accelerate.app.beta.insly.training",
                  reAuthenticate: "If refresh fails, use identifier_login to get new tokens",
