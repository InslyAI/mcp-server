...
const siteServiceTools: Tool[] = [
  // Tenant Features
  {
    ...
    description: 'Get tenant broker feature configuration for specific feature and broker',
    category: 'Tenant Features',
    method: 'GET',
    endpoint: '/api/v1/sites/features/{tenantTag}/{featureName}/{broker}',
    parameters: ['tenantTag', 'featureName', 'broker', 'bearerToken', 'tenantId']
  },
  {
  ...
  // Claim Features
  {
    ...
    description: 'Get tenant claim features - internal use for deploy automation',
  ...
  },
  {
    ...
    parameters: ['tenantTag', 'schemaName', 'features', 'bearerToken', 'tenantId']
  },
  {
    ...
    category: 'Claim Features',
    method: 'GET',
    endpoint: '/api/v1/sites/claim-features/{tenantTag}/{schemaName}/{featureName}',
    parameters: ['tenantTag', 'schemaName', 'featureName', 'bearerToken', 'tenantId']
  },
  {
    ...
    method: 'POST',
    endpoint: '/api/v1/sites/claim-features/{tenantTag}/{schemaName}/{featureName}',
    parameters: ['tenantTag', 'schemaName', 'featureName', 'config', 'bearerToken', 'tenantId']
  },

  // Products
  {
    name: 'site_service_products_create',
    description: 'Create new product with schemas, schema features and product features',
    category: 'Products',
    method: 'POST',
  ...
  },
  {
    ...
    parameters: ['tenantTag', 'source', 'targetName', 'targetTitle', 'bearerToken', 'tenantId']
  },
  ...
  },
  {
    ...
    category: 'Product Features',
    method: 'GET',
    endpoint: '/api/v1/sites/product-features/{tenantTag}/{schemaName}/{featureName}',
    parameters: ['tenantTag', 'schemaName', 'featureName', 'bearerToken', 'tenantId']
  },
  {
  ...
  },
  {
    ...
    method: 'POST',
    endpoint: '/api/v1/sites/schemes/configurations/{tenantTag}/{type}/{name}',
    parameters: ['tenantTag', 'type', 'name', 'schema', 'bearerToken', 'tenantId']
  },
  {
  ...
  },
  {
    ...
    category: 'Schemes',
    method: 'GET',
    endpoint: '/api/v1/sites/schemes/configurations/{tenantTag}/{type}/{name}/{version}',
    parameters: ['tenantTag', 'type', 'name', 'version', 'bearerToken', 'tenantId']
  },
  {
    ...
    category: 'Schemes',
    method: 'GET',
    endpoint: '/api/v1/sites/schemes/configurations/{tenantTag}/{type}/{name}/{version}/ui',
    parameters: ['tenantTag', 'type', 'name', 'version', 'bearerToken', 'tenantId']
  },
  {
    ...
    method: 'PUT',
    endpoint: '/api/v1/sites/schemes/configurations/{tenantTag}/{type}/{name}/{version}/ui',
    parameters: ['tenantTag', 'type', 'name', 'version', 'uiSchema', 'bearerToken', 'tenantId']
  },
  {
    ...
    category: 'Schemes',
    method: 'GET',
    endpoint: '/api/v1/sites/schemes/configurations/{tenantTag}/{type}/{name}/ui',
    parameters: ['tenantTag', 'type', 'name', 'bearerToken', 'tenantId']
  },
  {
  ...
  // Scheme Features
  {
    ...
    description: 'Get tenant scheme features - internal use for deploy automation',
  ...
  },
  {
    ...
    category: 'Scheme Features',
    method: 'POST',
    endpoint: '/api/v1/sites/scheme-features/{tenantTag}/{schemaType}/{schemaName}',
    parameters: ['tenantTag', 'schemaType', 'schemaName', 'features', 'bearerToken', 'tenantId']
  },
  {
  ...
  },
  {
    ...
    category: 'Scheme Features',
    method: 'GET',
    endpoint: '/api/v1/sites/scheme-features/{tenantTag}/{schemaType}/{schemaName}/{featureName}',
    parameters: ['tenantTag', 'schemaType', 'schemaName', 'featureName', 'bearerToken', 'tenantId']
  },
  {
    ...
    method: 'POST',
    endpoint: '/api/v1/sites/scheme-features/{tenantTag}/{schemaType}/{schemaName}/{featureName}',
    parameters: ['tenantTag', 'schemaType', 'schemaName', 'featureName', 'config', 'bearerToken', 'tenantId']
  },
...
const categories = Array.from(new Set(siteServiceTools.map(tool => tool.category)));
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Tenant configuration management, features, products, and schemes</p>
            </div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white rounded-lg p-4 border">
              <div className="text-2xl font-bold text-yellow-600">{siteServiceTools.length}</div>
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            <div className="bg-white rounded-lg border p-4">
              <h3 className="font-semibold text-gray-900 mb-2">Tenant Features</h3>
              <p className="text-sm text-gray-600 mb-3">
                Complete tenant configuration management including feature toggles, broker settings, and public feature access.
              </p>
            ...
            <div className="bg-white rounded-lg border p-4">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Product creation, copying, and feature configuration with complete schema and feature management.
              </p>
              <div className="text-xs text-yellow-600">Schema Driven</div>
            </div>
            <div className="bg-white rounded-lg border p-4">
              <h3 className="font-semibold text-gray-900 mb-2">Scheme Administration</h3>
              <p className="text-sm text-gray-600 mb-3">
                JSON schema management with versioning, UI schema support, and configuration deployment.
              </p>
            ...
            <div className="bg-white rounded-lg border p-4">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Static document upload, storage, and management with folder organization and path-based access.
              </p>
        ...
        {categories.map(category => {
          const categoryTools = siteServiceTools.filter(tool => tool.category === category);
                        ...
                        <div className="mt-3 pt-3 border-t border-gray-100">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {tool.parameters.map(param => (
                              <span key={param} className="px-2 py-1 bg-yellow-50 text-yellow-700 text-xs rounded">
                                {param}
                              </span>
                            ))}
                          </div>
        ...
        <div className="mt-8 bg-white rounded-lg border p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-medium text-gray-900 mb-2">Required Authentication</h3>
              <ul className="text-sm text-gray-600 space-y-1">
                ...
                <li>• Base URL: https://&#123;tenantId&#125;.app.beta.insly.training</li>
              </ul>
            </div>
            <div>
              <h3 className="font-medium text-gray-900 mb-2">Configuration Scope</h3>
              <ul className="text-sm text-gray-600 space-y-1">
